...
SWIFT_CLASS("_TtC19MultiCollectionView11AppDelegate")
...
SWIFT_CLASS("_TtC19MultiCollectionView24CustomCollectionViewCell")
...
SWIFT_CLASS("_TtC19MultiCollectionView30CustomCollectionViewFlowLayout")
@interface CustomCollectionViewFlowLayout : UICollectionViewFlowLayout
@property (nonatomic, copy) NSArray * __nonnull indexPathsToAnimate;
+ (CustomCollectionViewFlowLayout * __nonnull)flowlayout:(CGSize)itemSize minLineSpacing:(CGFloat)minLineSpacing minItemSpacing:(CGFloat)minItemSpacing inset:(UIEdgeInsets)inset;
- (UICollectionViewLayoutAttributes * __nullable)initialLayoutAttributesForAppearingItemAtIndexPath:(NSIndexPath * __nonnull)itemIndexPath;
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)newBounds;
- (void)prepareForCollectionViewUpdates:(NSArray * __null_unspecified)updateItems;
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC19MultiCollectionView18MainViewController")
...
- (IBAction)changeLayout:(id __nonnull)sender;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19MultiCollectionView14ViewController")
